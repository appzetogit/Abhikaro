...
const transactionSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['commission', 'withdrawal', 'refund', 'bonus', 'deduction'],
    required: true
  },
  status: {
    type: String,
...
hotelWalletSchema.methods.addTransaction = function(transactionData) {
  ...
  if (transaction.status === 'Completed') {
    if (transaction.type === 'commission' || transaction.type === 'bonus' || transaction.type === 'refund') {
...
hotelWalletSchema.methods.updateTransactionStatus = function(transactionId, status, failureReason = null) {
