...
import {
  getRestaurantFinance,
  getRestaurantCommissionInfo,
...
router.delete('/menu/section/:sectionId/item/:itemId', authenticate, deleteMenuItem);
...
router.get("/commission", authenticate, getRestaurantCommissionInfo);
