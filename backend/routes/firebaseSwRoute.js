...
`;
    ...
    res.setHeader('Content-Security-Policy', "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.gstatic.com https://gstatic.com https://www.gstatic.com https://*.google.com https://www.google.com https://*.googleapis.com https://apis.google.com; connect-src 'self' https: wss: ws: http:;");
    res.send(swContent);
  } catch (err) {
