...
export const API_ENDPOINTS = {
  ...
  HOTEL: {
    AUTH: {
      SEND_OTP: "/hotel/auth/send-otp",
      VERIFY_OTP: "/hotel/auth/verify-otp",
      REFRESH_TOKEN: "/hotel/auth/refresh-token",
      LOGOUT: "/hotel/auth/logout",
      ME: "/hotel/auth/me",
    },
    PROFILE: "/hotel/profile",
    QR_CODE: "/hotel/profile/qr-code",
    WALLET: "/hotel/wallet",
  ...
  ADMIN: {
    ...
    USER_WALLET_HISTORY: "/admin/users/:id/wallet/history",
    ...
    DELIVERY_TERMS: "/admin/delivery-terms",
    DELIVERY_TERMS_PUBLIC: "/delivery-terms/public",
    DELIVERY_PRIVACY: "/admin/delivery-privacy",
    DELIVERY_PRIVACY_PUBLIC: "/delivery-privacy/public",
    RESTAURANT_TERMS: "/admin/restaurant-terms",
    PRIVACY: "/admin/privacy",
    PRIVACY_PUBLIC: "/privacy/public",
    RESTAURANT_PRIVACY: "/admin/restaurant-privacy",
    REFUND: "/admin/refund",
    ...
    CUSTOMER_CONTACT_US: "/admin/customer-contact-us",
    CUSTOMER_CONTACT_US_CREATE: "/contact-us",
    CUSTOMER_CONTACT_US_BY_ID: "/admin/customer-contact-us/:id",
    CUSTOMER_CONTACT_US_STATUS: "/admin/customer-contact-us/:id/status",
    REVIEWS: "/admin/reviews",
    REVIEWS_BY_RESTAURANT: "/admin/reviews/restaurant/:restaurantId",
    REVIEW_UPDATE: "/admin/reviews/:orderId",
    REVIEW_DELETE: "/admin/reviews/:orderId",
    RESTAURANT_RATING_UPDATE: "/admin/reviews/restaurant/:restaurantId/rating",
    ...
    NOTIFICATIONS_HISTORY_STATUS: "/admin/notifications/history/:id/status",
    NOTIFICATIONS_HISTORY_BY_ID: "/admin/notifications/history/:id",
    ...
    ORDER_RESEND_RESTAURANT_NOTIFICATION:
      "/admin/orders/:id/resend-restaurant-notification",
  },
  // Order endpoints
  ORDER: {
    CREATE: "/order",
