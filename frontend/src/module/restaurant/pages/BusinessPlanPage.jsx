...
export default function BusinessPlanPage() {
  ...
  const plan = {
    ...
    rate: "10.0 %",
    description:
      "Restaurant will pay 10.0% commission from each order. You will get access of all the features and options in restaurant panel, app and interaction with user.",
  }
