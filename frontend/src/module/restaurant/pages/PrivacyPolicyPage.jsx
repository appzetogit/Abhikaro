  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        setLoading(true)
        setLoadError("")
        const res = await api.get("/restaurant/public/privacy")
        ...
        console.error("Failed to load restaurant privacy policy:", e)
        if (mounted) setLoadError("Failed to load Privacy Policy.")
      } finally {
