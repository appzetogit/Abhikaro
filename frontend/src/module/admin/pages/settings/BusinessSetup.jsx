              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.payAtHotelMaxTotal}
                    onChange={(e) => handleInputChange("payAtHotelMaxTotal", e.target.value)}
                    className="w-full pl-6 pr-3 py-2 text-xs border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  />
                </div>
              </div>
