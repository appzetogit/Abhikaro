        ...
        <div className="p-6">
          ...
          {loadingFeeSettings ? (
            ...
            <>
              ...
              <div className="mb-8 border-t border-slate-200 pt-6 mt-6">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900">Platform Fee by Distance Range</h3>
                    <p className="text-sm text-slate-500 mt-1">
                      Set different platform fees based on distance ranges (in kilometers)
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                  ...
                  <p className="text-xs text-slate-500 mt-2">
                    Example: If distance is 0-2 km, platform fee will be ₹5. If distance is 2-4 km, platform fee will be ₹10.
                  </p>
                </div>
              </div>
