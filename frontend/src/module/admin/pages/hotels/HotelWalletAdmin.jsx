  ...
  const handleSaveCashCollected = async () => {
    ...
    if (String(balanceAmount || "").trim()) {
      ...
      if (Number.isNaN(amt) || amt <= 0) {
        setEditError("Please enter a valid positive balance adjustment amount")
        return
      }
      balanceAdjustment = {
        type: balanceAction,
              ...
              <div className="grid grid-cols-1 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-slate-400"
                    placeholder="e.g. 500"
                  />
                </div>
                <div>
