...
export default function DiningRestaurants() {
  ...
  const { location, loading } = useSharedLocation()
  ...
  useEffect(() => {
    ...
    // Wait until location hook finishes initial load so city filter is stable
    if (!loading) {
  ...
  const toggleFilter = (filterId) => {
    setActiveFilters(prev => {
      ...
      // Enforce mutual exclusivity for distance filters
