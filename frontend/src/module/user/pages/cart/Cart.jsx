...
export default function Cart() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // Get hotel reference from localStorage if available (set when user scans hotel QR code)
      const hotelReference = localStorage.getItem("hotelReference");
      const hotelName = localStorage.getItem("hotelReferenceName");
      ...
      const orderPayload = {
        ...
        // Add hotel reference if available
      ...
      // if (hotelReference) {
      //   localStorage.removeItem("hotelReference")
      //   localStorage.removeItem("hotelReferenceName")
      //   localStorage.removeItem("hotelReferenceTimestamp")
      // }
